    ...
    def test_make_decay(self):
        class Do(DecayObj):
            def __init__(self):
                ...
                DecayObj.__init__(self, decays = None)
        dobj = Do()
        dobj.decays = {'phosphate' : {'constant' : 0.001,
                                      'exponent' : 1.005}}
