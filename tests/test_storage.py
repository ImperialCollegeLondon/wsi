...
from wsimod.nodes.storage import Storage, Groundwater, QueueGroundwater, River, Reservoir, RiverReservoir
...
class MyTestClass(TestCase):
    ...
    def test_qgroundwater_push(self):
        constants.set_simple_pollutants()
        groundwater = QueueGroundwater(name='',
                                      capacity = 10,
                                      timearea = {0 : 0.2,
                                                  1 : 0.8}
                                      )
    ...
    def test_river_pull(self):
        ...
        river = River(name='',
                        ...
                        damp = 0.1,
                        mrf = 10,
                        initial_storage = {'volume' : 30,
                                           'phosphate' : 0.2,
                                           'temperature' : 23}
                        )
        d1 = {'volume': 19.988412514484356,
    ...
    def test_reservoir(self):
        ...
        d1 = {'volume' : 3,
                           'phosphate' : 0.1,
                           'temperature' : 10}
        reservoir2 = Reservoir(name = '',
                               capacity = 5,
                                initial_storage = d1
                                )
                                
        arc1 = Arc(in_port = reservoir2,
                   out_port = reservoir1,
                   name = '')
    ...
    def test_riverreservoir_push(self):
        ...
        reply = reservoir.push_set({'volume' : 35,
                                    'phosphate' : 0.5,
                                    'temperature' : 20})
        d2 = {'volume' : 10,
    ...
    def test_riverreservoir_environmental(self):
        ...
        reply = reservoir.push_set({'volume' : 10,
                                    'phosphate' : 0.5,
                                    'temperature' : 20})
