...
from wsimod.arcs.arcs import Arc, QueueArc, AltQueueArc, DecayArc, DecayArcAlt
...
class MyTestClass(TestCase):
    ...
    def test_altqueue_arc_sum(self):
        ...
        arc1 = AltQueueArc(in_port = node1, 
                        out_port = node2, 
                        name = 'arc1',
                        capacity = 10,
                        number_of_timesteps = 1
    ...
    def test_decay_arc(self):
        ...
        node2 = Waste(name = '2')
        node1.t = 1
        arc1 = DecayArc(in_port = node1, 
                        out_port = node2, 
                        name = 'arc1',
                        capacity = 10,
                        decays = {'phosphate' : {'constant' : 0.005,
                                                 'exponent' : 1.005}},
                        number_of_timesteps = 1
                        )
        d1 = {'volume' : 10,
    ...
    def test_decay_arc_alt(self):
        ...
        node2 = Waste(name = '2')
        node1.t = 1
        arc1 = DecayArcAlt(in_port = node1, 
                        out_port = node2, 
                        name = 'arc1',
                        capacity = 10,
                        number_of_timesteps = 1,
