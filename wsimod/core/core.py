...
class WSIObj:
    ...
    def __init__(self):
        """WSIObj is the base object of everything in WSIMOD. It is used to perform
        VQIP operations and mass balance checking behaviour.
    ...
    def blend_vqip(self, c1, c2):
        """Blends together two VQIPs that are assumed to have pollutant entries set 
        as pollution concentrations, blending occurs with proportionate mixing.
    ...
    def sum_vqip(self, t1, t2):
        ...
        mass. Volume and additive pollutants are summed while non additive pollutants
        are proportionately blended.
    ...
    def extract_vqip(self, t1, t2):
        ...
        mass totals. Each volume and additive pollutant is directly subtracted.
    ...
    def ds_vqip_c(self, c, c_):
        """Get difference between each additive pollutant and volume for VQIPs where 
        pollutants are given as concentrations but difference is given as mass 
        totals.
    ...
    def mass_balance(self):
        """Call all mass balance functions and compare to see if discrepancy (i.e., 
        if in_ != (out_ + ds_) for volume or for any additive pollutant).
