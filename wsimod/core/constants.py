...
MAX_INFLOW = 1e10
DT_DAYS = 1
POLLUTANTS = ['do','org-phosphorus','phosphate','ammonia','solids','bod','cod','ph','temperature','nitrate','nitrite'] # All assume mg/l
NON_ADDITIVE_POLLUTANTS = ['temperature', 'ph'] # e.g. pollutants whose concentration in a vqip should not increase if volume is distilled out
ADDITIVE_POLLUTANTS = ['do','org-phosphorus','phosphate','ammonia','solids','bod','cod','nitrate','nitrite'] # All assume mg/l
NUTRIENTS = ['N','P']
