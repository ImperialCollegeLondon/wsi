...
MAX_INFLOW = 1e10
DT_DAYS = 1
POLLUTANTS = ['do','phosphorus','phosphate','ammonium','solids','bod','cod','ph','temperature','nitrate','nitrite'] # All assume mg/l
...
ADDITIVE_POLLUTANTS = ['do','phosphorus','phosphate','ammonium','solids','bod','cod','nitrate','nitrite'] # All assume mg/l
NUTRIENTS = ['N','P']
