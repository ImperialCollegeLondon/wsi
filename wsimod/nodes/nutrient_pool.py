...
class NutrientPool:
    ...
    def apply_overrides(self, overrides = Dict[str, Any]):
        ...
        """
        self.fraction_manure_to_dissolved_inorganic = overrides.pop("fraction_manure_to_dissolved_inorganic", 
                                                                    self.fraction_manure_to_dissolved_inorganic)
        self.fraction_residue_to_fast = overrides.pop("fraction_residue_to_fast", 
        ...
        self.fraction_dry_n_to_dissolved_inorganic = overrides.pop("fraction_dry_n_to_dissolved_inorganic", 
                                                                   self.fraction_dry_n_to_dissolved_inorganic)
        self.degrhpar = overrides.pop("degrhpar", 
                                      self.degrhpar)
        self.dishpar = overrides.pop("dishpar", 
                                     self.dishpar)
        self.minfpar = overrides.pop("minfpar", 
                                     self.minfpar)
        self.disfpar = overrides.pop("disfpar", 
                                     self.disfpar)
        self.immobdpar = overrides.pop("immobdpar", 
                                     self.immobdpar)
