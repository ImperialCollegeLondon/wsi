...
class Land_(Node):
    ...
    def create_runoff(self):
        ...
        for sname, surface in self.surfaces.items():
            ...
            temp_tracking['runoff'][sname] = runoff
        ...
        if infiltration_remaining['volume'] > constants.FLOAT_ACCURACY:
...
class Surface(Tank):
    ...
    def apply_precipitation(self):
        ...
        #Convert to recharge
        runoff = self.area * precipitation_mm * constants.MM_M2_TO_M3
    ...
    def pull_evaporation(self):
        ...
        evaporation = self.area * evaporation_mm * constants.MM_M2_TO_M3
    ...
    def pull_infiltration(self):
       #Get infiltration (TODO maybe read data here... or something smart)
        ...
        #Convert to an amount
        infiltration = self.area * infiltration_mm * constants.MM_M2_TO_M3

        #Update tank
        infiltration = self.pull_storage({'volume' : infiltration})
